...
export class ServiciosService {
  ...
  obtenerServiciosidHotel(idHotel: String): Observable<any> {
    return this._http.get(this.url + '/obtenerServicio/' + idHotel, {
  ...
  obtenerServicioID(idServicio: String, token: any): Observable<any> {
    ...
    return this._http.get(this.url + '/obtenerServicioId/' + idServicio, {
      headers: headersToken,
    });
  }

  agregarServicio(
    modeloServicio: ServiciosModel,
    idHotel: String,
    token: any
  ): Observable<any> {
    let headersToken = this.headersVariable.set('Authorization', token);
    ...
    return this._http.post(
      this.url + '/agregarServicio/' + idHotel,
      parametros,
      { headers: headersToken }
    );
  }
  ...
  reservarServicio(
    ...
    return this._http.put(
      this.url + '/reservarServicio/' + modeloServicio._id,
      parametros,
      { headers: headersToken }
    );
  }
