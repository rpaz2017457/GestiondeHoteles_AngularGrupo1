...
export class HotelesService {
  ...
  obtenerHoteles(): Observable<any> {
    return this._http.get(this.url + '/buscarHotel', {
  ...
  obtenerHotelesPais(token: any): Observable<any> {
    ...
    return this._http.get(this.url + '/buscarHotelPorPais', {
  ...
  obtenerHotelesId(id: any, token: any): Observable<any> {
    let headersToken = this.headersVariable.set('Authorization', token);
    return this._http.get(this.url + '/buscarHotelPorId/' + id, {
      headers: headersToken,
    });
  }

  obtenerHotelesDisponibles(nombreHotel: String): Observable<any> {
    return this._http.post(this.url + '/buscarHotelDisponible', nombreHotel, {
      headers: this.headersVariable,
    });
  }
