...
export class EventosService {
  ...
  obtenerEventos(idHotel: String): Observable<any> {
    console.log(idHotel);
    return this._http.get(this.url + '/buscarEvento/' + idHotel, {
      headers: this.headersVariable,
    });
  }
  obtenerEventosID(idEvento: String, token: any): Observable<any> {
    let headersToken = this.headersVariable.set('Authorization', token);
    return this._http.get(this.url + '/buscarEventoPorID/' + idEvento, {
  ...
  agregarEvento(modeloEvento: EventosModel, token: any) {
    ...
    return this._http.post(this.url + '/agregarEvento', parametros, {
      headers: headersToken,
    });
  }
  editarEvento(modeloEvento: EventosModel, token: any) {
    ...
    return this._http.put(
      this.url + '/editarEvento/' + modeloEvento._id,
      parametros,
      { headers: headersToken }
    );
  }
  ...
  eliminarEvento(idEvento: String, token: any) {
    let headersToken = this.headersVariable.set('Authorization', token);
    return this._http.delete(this.url + '/eliminarEvento/' + idEvento, {
      headers: headersToken,
    });
  }
  ...
  reservarEvento(modeloEvento: EventosModel, token: any) {
    ...
    return this._http.put(
      this.url + '/reservarEvento/' + modeloEvento._id,
      parametros,
      { headers: headersToken }
    );
  }
